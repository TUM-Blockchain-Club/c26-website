    ...
    posts: [
      {
        ...
        variants: {
          ...
          long: `🎉 Early Bird tickets for the TUM Blockchain Conference 26 are live!\n\nOct 29 to 31 in Munich, Germany's leading student run blockchain conference. Three days of talks, a Digital Assets Day by ${BB_X} and a 30h Hackathon.\n\nGrab yours before Early Bird ends July 31 → ${LINK}\n\nHosted by ${X}. #TUMBlockchainConference26`,
        },
      },
      {
        platform: "Instagram",
        variants: {
          ...
          long: `🎉 Early Bird tickets for the TUM Blockchain Conference 26 are officially live!\n\nJoin us Oct 29 to 31 in Munich for Germany's leading student run blockchain conference. Three days of talks, workshops, a Digital Assets Day by Bundesblock and a 30h Hackathon. Get yours before Early Bird ends July 31 (link in bio: ${LINK}) 🚀\n\nHosted by ${IG}. #TUMBlockchainConference26 #Web3 #Munich`,
        },
      },
      {
        platform: "LinkedIn",
    ...
    posts: [
      {
        ...
        variants: {
          ...
          long: `📣 We're proud to be a Community Partner of the TUM Blockchain Conference 26!\n\nJoin us Oct 29 to 31 in Munich, Germany's leading student run blockchain conference: talks, a Digital Assets Day by ${BB_X} and a 30h Hackathon. Hosted by ${X}.\n\nSee you there → ${LINK} #TUMBlockchainConference26`,
        },
      },
      {
        platform: "Instagram",
        variants: {
          ...
          long: `📣 We're a proud Community Partner of the TUM Blockchain Conference 26!\n\nJoin us Oct 29 to 31 in Munich for Germany's leading student run blockchain conference. Three days of talks, workshops, a Digital Assets Day by Bundesblock and a 30h Hackathon (link in bio: ${LINK}) 🎉\n\nHosted by ${IG}. #TUMBlockchainConference26 #Web3 #Munich`,
        },
      },
      {
        platform: "LinkedIn",
