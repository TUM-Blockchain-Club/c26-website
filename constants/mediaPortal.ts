...
export const lastYearParagraphs = [
  "The TUM Blockchain Conference 25 brought together more than 1,200 attendees in Munich and confirmed the event as Germany's leading student run blockchain conference. Students, builders, researchers, founders and policymakers came together for 57 talks, 12 panels and 4 workshops covering the whole spectrum of Web3, from infrastructure and applications to regulation and research, alongside an Ideathon and a Researchathon.",
...
export const thisYearParagraphs = (earlyBird: boolean) => {
  const paragraphs = [
    "The TUM Blockchain Conference 26 takes place October 29 to 31, 2026 at the House of Communication in Munich, hosted by TUM Blockchain Club. Three days bring together students, builders, researchers, founders and policymakers, and everyone is welcome: you do not need to be a student or an expert to attend.",
...
export const mediaNewsletter = (earlyBird: boolean) => ({
  ...
  body: `The TUM Blockchain Conference 26 takes place October 29 to 31 at the House of Communication in Munich. It is Germany's leading student run blockchain conference, hosted by TUM Blockchain Club, and everyone is welcome, whether you are deep in the space or simply curious.
