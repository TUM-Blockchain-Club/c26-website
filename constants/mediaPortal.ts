...
export const thisYearParagraphs = (earlyBird: boolean) => {
  const paragraphs = [
    "The TUM Blockchain Conference 26 takes place October 29 to 31, 2026 at the House of Communication in Munich, hosted by TUM Blockchain Club. It is an initiative at TUM, the Technical University of Munich, one of the leading universities in Europe. Three days where curious newcomers, students, builders, researchers, founders, policymakers and industry leaders all come together, and everyone is welcome: you do not need to be a student or an expert to attend.",
