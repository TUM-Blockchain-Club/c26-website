...
const TicketNotification = () => {
  return (
    <section className="w-full" aria-labelledby="ticket-notification-title">
      <div className="mx-auto flex max-w-4xl flex-col gap-6 rounded-sm border border-line bg-white/[0.04] p-6 shadow-glow backdrop-blur md:flex-row md:items-center md:justify-between md:p-8">
